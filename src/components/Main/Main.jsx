        ...
        <div className='MainDiv'>
            <div className='FirstDiv'>
                <div className='ImageWrapper'>
                    <img src='../../assets/29VZU50MX2_1.jpg' className='img1' alt='Sonny' />
                    <img src='../../assets/611816110013219063_1.jpg' className='img2' alt='Image'  />
            ...
            <div className='SecondDiv'>
                <div className='ImageWrapper'>
                    <img src='../../assets/2wp-18.jpg' className='img3' alt='Sonny' />
                    <img src='../../assets/cd662f36-1d70-4d95-b4a9-e52234ae7c71.webp' className='img4' alt='Image' ref={secondTextRef}/>
            ...
            <div className='ThirdDiv'>
                <div style={{display:"flex", justifyContent:"space-around", marginBottom:"80px"}}>
                    <div style={{display:"flex", flexDirection:"column", gap:"10px", alignItems:"center"}}>
                        <img src='/assets/free-icon-trophy-7586359.png' style={{width:"80px"}}></img>
                    ...
                    <div style={{display:"flex", flexDirection:"column", gap:"10px", alignItems:"center"}}>
                        <img src='/assets/free-icon-hotel-9201025.png' style={{width:"80px"}}></img>
                ...
                <div style={{display:"flex", flexDirection:"column", gap:"10px", alignItems:"center"}}>
                        <img src='/assets/free-icon-museum-8288192.png' style={{width:"80px"}}></img>
                    ...
                    <div style={{display:"flex", flexDirection:"column", gap:"10px", alignItems:"center"}}>
                        <img src='/assets/free-icon-soccer-10809126.png' style={{width:"80px"}}></img>
                    ...
                    <div style={{display:"flex", flexDirection:"column", gap:"10px", alignItems:"center"}}>
                        <img src='/assets/free-icon-backpacking-7058150.png' style={{width:"80px"}}></img>
