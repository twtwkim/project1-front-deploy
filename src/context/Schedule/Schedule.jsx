                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/Berlin_Brandenburger_Tor_Abend.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/d4aa093a130ad694919809eacd5f7132.jpg' style={{width:'50%'}}></img>
                                </div>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/WclR_763CzDEfOrW4jvGtN8Iwld7dGZxko8z5Fsae_NBwbaMCS93MoWw_8RK0tfCmWQMa0IBCo7zlQBQl_un0Q.webp' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/67532655-독일-국회-의사당-deutscher-bundestag-의-독일-의회-reichstag-건물은-독일-베를린의-미테-mitte-지구에.jpg' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div className='day2-detail-match1'>
                                    <img src='/assets/Bandera_de_España.svg' style={{width:"70px"}}/>
                                    ...
                                    <img src='/assets/다운로드.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div className='day2-detail-match1'>
                                <img src='/assets/england.png' style={{width:"70px"}}/>
                                    {slide && slide.matchups && slide.matchups.length > 0 && (
                                        <div>
                                    ...
                                    <img src='/assets/serbia.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
                ...
                <div id="day4" className='day4'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/50009868.cms' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/istockphoto-547022042-612x612.jpg' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/mainImage.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/view.jpg' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div className='day2-detail-match1'>
                                <img src='/assets/france.png' style={{width:"70px"}}/>
                                    {slide && slide.matchups && slide.matchups.length > 0 && (
                                        <div>
                                    ...
                                    <img src='/assets/austria.svg' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
