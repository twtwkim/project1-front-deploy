                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/40527-National-Football-Museum.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/39ec442449bf6458a95cdfdb6241b859.webp' style={{width:'50%'}}></img>
                                </div>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/store-entrance.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/0_Classic-Football-Shirts.webp' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <img src='/assets/680.png' style={{width:"70px"}}/>
                ...
                <div id="day3" className='day3'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/90848-London.avif' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/302378-Tower-Bridge.avif' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                ...
                <div id="day4" className='day4'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/x720.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/classic-football-shirts-shop-in-the-old-truman-brewery-off-brick-lane-east-london-selling-retro-and-vintage-football-shirts-founded-manchester-2006-T99R8N.jpg' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                                축구와 관련된 다양한 상품을 볼 수 있는 축덕들의 성지이며, 축구를 좋아하는 사람이라면 반드시 들려봐야될 장소이다.
                                </div>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div className='day2-detail-match1'>
                                <img src='/assets/602.png' style={{width:"70px"}}/>
                                    {slide && slide.matchups && slide.matchups.length > 0 && (
                                        <div>
                                    ...
                                    <img src='/assets/915.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
                ...
                <div id="day5" className='day5'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/84621-Paris.webp' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/534568-16th-arrondissement.avif' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/474411-Champs-Elysees-Neighborhood.avif' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/20085-Arc-De-Triomphe.avif' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div className='day2-detail-match1'>
                                <img src='/assets/868.png' style={{width:"70px"}}/>
                                    {slide && slide.matchups && slide.matchups.length > 0 && (
                                        <div>
                                    ...
                                    <img src='/assets/1668.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
