                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/SGM_Altes-Rathaus_Foto-Markus-Scholz-1100x733-1.webp' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/altes-rathaus-leipzig-mit-stadtgeschichtlichem-museum-museen-in-leipzig.jpg' style={{width:'50%'}}></img>
                                </div>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/166060-Bach-Museum.avif' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/jpg.jpg' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <img src='/assets/france.png' style={{width:"70px"}}/>
                                    ...
                                    <img src='/assets/네덜란드.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                        </div>
                        <div className='day2-detail-title'>
                ...
                <div id="day4" className='day4'>
                    ...
                    <div className='day2-detail'>
                        ...
                        <div className='day2-detail-title-sub' style={{marginBottom:"50px"}}>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/217925-Romerplatz.jpg' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/Frankfurt-am-Main-Roemerberg.webp' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title-sub'>
                                ...
                                <hr/>
                                <div className='day2-detail-title-image'>
                                    <img src='/assets/217545-Hessen-Germany.avif' style={{width:'50%', marginRight:"10px"}}></img>
                                    <img src='/assets/45540-Frankfurt-Cathedral.avif' style={{width:'50%'}}></img>
                                </div>
                                <div style={{lineHeight:"20px"}}>
                        ...
                        <div className='day2-detail-title'>
                            ...
                            <div className='day2-detail-info'>
                                ...
                                <div style={{fontSize:"1rem", color:"black"}}>유로 2024 2경기 관람</div>
                                <div className='day2-detail-match1'>
                                <img src='/assets/독일.png' style={{width:"70px"}}/>
                                    {slide && slide.matchups && slide.matchups.length > 0 && (
                                        <div>
                                    ...
                                    <img src='/assets/스위스.png' style={{width:"70px"}}/>
                                </div>
                            </div>
                            </div>
                        </div>
